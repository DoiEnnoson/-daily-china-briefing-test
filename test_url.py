...
def fetch_original_url(google_url):
    ...
    try:
        ...
        # Erster Versuch: Ohne Weiterleitungen, um Redirect-URL zu erfassen
        ...
        if response.status_code in (301, 302, 303):
            ...
            if redirect_url:
                ...
                print("Kein Redirect-URL in Header gefunden")
        # Zweiter Versuch: Mit Weiterleitungen, um Seite zu parsen
        ...
        if response.status_code == 200:
            ...
            # Suche nach <script>-Tags mit Weiterleitungs-URLs
            ...
            # Debugging: Speichere gesamtes HTML für Analyse
            with open('debug_html.html', 'w', encoding='utf-8') as f:
                f.write(str(soup))
            print("Gesamtes HTML in 'debug_html.html' gespeichert")
            # Gib die ersten 2000 Zeichen des HTML aus
